...
class myICM42688{
  public:
    ...
    myICM42688(TwoWire &bus,uint8_t address);
    myICM42688(SPIClass &bus,uint8_t csPin);
    int begin();
...
class myICM42688_FIFO: public myICM42688 {
  public:
    using myICM42688::myICM42688;
